Movie.create!([
  ...
  },
  {
    ...
    released_on: "2002-03-12",
    cast: "Mila Jovovich, Michelle Rodriguez, Colin Salmon",
    director: "Paul W. S. Anderson",
    duration: "1h 40m",
    image_file_name: "RE.jpg"
  },
  {
    title: "World War Z",
    rating: "PG-13",
    total_gross: 202359711,
    ...
    released_on: "2013-06-21",
    cast: "Brad Pitt, Mireille Enos, Matthew Fox",
    director: "Marc Forster",
    duration: "2h 3m",
    image_file_name: "WWZ.jpeg"
  }
])

movie = Movie.find_by(title: 'World War Z')
...
movie = Movie.find_by(title: 'Resident Evil')
